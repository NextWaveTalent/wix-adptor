...
/** @enumType */
export type TypeWithLiterals = Type | 'UNKNOWN' | 'DELETE_BY_QUERY' | 'COPY_FIELD_DATA' | 'EDIT_FIELD_DATA' | 'UPDATE_PUBLISH_STATUS';
...
/** @enumType */
export type StatusWithLiterals = Status | 'NEW' | 'RUNNING' | 'COMPLETED' | 'FAILED';
...
export interface UpdatePublishStatusOptions extends UpdatePublishStatusOptionsOptionsOneOf {
...
/** @enumType */
export type OperationWithLiterals = Operation | 'UNDEFINED' | 'SET_PUBLISHED_STATUS' | 'SET_DRAFT_STATUS' | 'SCHEDULE_PUBLISHED_STATUS' | 'SCHEDULE_DRAFT_STATUS' | 'CANCEL_SCHEDULING';
 ...
 */
export declare function createTask(task: NonNullablePaths<Task, `copyFieldDataOptions.dataCollectionId` | `copyFieldDataOptions.sourceFieldKey` | `copyFieldDataOptions.targetFieldKey` | `deleteByQueryOptions.dataCollectionId` | `editFieldDataOptions.dataCollectionId` | `editFieldDataOptions.fieldKey` | `type` | `updatePublishStatusOptions.dataCollectionId` | `updatePublishStatusOptions.operation`>): Promise<NonNullablePaths<Task, BackgroundTaskNonNullablePaths>>;
/**
 ...
 */
export declare function listTasks(options?: ListTasksOptions): Promise<NonNullablePaths<ListTasksResponse, {
 ...
 */
export declare function getTask(taskId: string): Promise<NonNullablePaths<Task, BackgroundTaskNonNullablePaths>>;
/**
 ...
 */
export declare function cancelTask(taskId: string): Promise<NonNullablePaths<CancelTaskResponse, {
