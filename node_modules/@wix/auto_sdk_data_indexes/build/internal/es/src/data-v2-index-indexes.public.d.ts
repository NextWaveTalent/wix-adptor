...
import { Index, ListAvailableIndexesResponse, ListIndexesOptions, ListIndexesResponse } from './data-v2-index-indexes.universal.js';
...
interface CreateIndexSignature {
     ...
     */
    (dataCollectionId: string, index: Index): Promise<Index>;
}
...
interface ListIndexesSignature {
     ...
     */
    (dataCollectionId: string, options?: ListIndexesOptions | undefined): Promise<ListIndexesResponse>;
}
/** @internal */
export declare function listAvailableIndexes(httpClient: HttpClient): ListAvailableIndexesSignature;
interface ListAvailableIndexesSignature {
    /**
     * Lists available indexes limits
     * @param - Data collection to show available indexes for
     */
    (dataCollectionId: string): Promise<ListAvailableIndexesResponse>;
}
export { CreateIndexRequest, CreateIndexResponse, DropIndexRequest, DropIndexResponse, Environment, Failure, Field, Index, IndexSource, ListAvailableIndexesRequest, ListAvailableIndexesResponse, ListIndexesOptions, ListIndexesRequest, ListIndexesResponse, Order, Paging, PagingMetadata, Status, } from './data-v2-index-indexes.universal.js';
