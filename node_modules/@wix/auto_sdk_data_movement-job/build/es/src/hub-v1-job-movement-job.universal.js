...
import * as ambassadorWixHubV1Job from './hub-v1-job-movement-job.http.js';
// @ts-ignore
 ...
 */
export async function submitJob(source, destination, options) {
    // @ts-ignore
 ...
 */
export async function createFileUploadUrl(options) {
    // @ts-ignore
 ...
 */
export async function listMovementLogs(jobId, options) {
    // @ts-ignore
