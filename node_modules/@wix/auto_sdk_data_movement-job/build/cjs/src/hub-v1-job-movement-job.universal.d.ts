 ...
 */
export declare function onJobCreated(handler: (event: JobCreatedEnvelope) => void | Promise<void>): void;
 ...
 * @documentationMaturity preview
 */
export declare function onJobDeleted(handler: (event: JobDeletedEnvelope) => void | Promise<void>): void;
 ...
 * @documentationMaturity preview
 */
export declare function onJobUpdated(handler: (event: JobUpdatedEnvelope) => void | Promise<void>): void;
 ...
 */
export declare function submitJob(source: NonNullablePaths<Source, `file.fileId` | `localization.languages` | `wixDataCollection.collectionId`>, destination: NonNullablePaths<Destination, `file.format` | `localization.languages` | `wixDataCollection.collectionId`>, options?: SubmitJobOptions): Promise<NonNullablePaths<SubmitJobResponse, {
 ...
 */
export declare function createFileUploadUrl(options?: CreateFileUploadUrlOptions): Promise<NonNullablePaths<CreateFileUploadUrlResponse, `fileId` | `uploadUrl`>>;
 ...
 */
export declare function getJob(jobId: string): Promise<NonNullablePaths<DataMovementJob, JobNonNullablePaths>>;
/**
 ...
 */
export declare function listJobs(options?: ListJobsOptions): JobsQueryBuilder;
 ...
 */
export declare function terminateJob(jobId: string): Promise<NonNullablePaths<TerminateJobResponse, {
    [P in JobNonNullablePaths]: `job.${P}`;
}[JobNonNullablePaths]>>;
/**
 ...
 */
export declare function listMovementLogs(jobId: string, options?: ListMovementLogsOptions): Promise<NonNullablePaths<ListMovementLogsResponse, `logs` | `logs.${number}.sourceItemId` | `logs.${number}.failure.code` | `logs.${number}.failure.description`>>;
